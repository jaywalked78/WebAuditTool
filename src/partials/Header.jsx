        ...
        <div className={`flex items-center justify-between h-16 ${variant === 'v2' || variant === 'v3' ? '' : 'lg:border-b border-gray-200 dark:border-gray-700/60'}`}>
          ...
          <div className="flex items-center">
            ...
            <div className="flex items-center ml-4 lg:ml-0">
              ...
              <div className="ml-3 text-sm text-gray-500 dark:text-gray-400 font-bold">
                Website Audit Tool
              </div>
          ...
          <div className="flex items-center space-x-3">
            {/* Search Modal - Commented out for clean demo */}
            {/* <div>
              <button
            ...
            {/* Notifications - Commented out for clean demo */}
            {/* <Notifications align="right" /> */}
            
            {/* Help - Commented out for clean demo */}
            {/* <Help align="right" /> */}
            
            {/* Theme toggle moved to left side with branding */}
            
            {/* Divider and User Menu - Commented out for clean demo */}
